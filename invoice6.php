...
<head>
	...
	<link rel="stylesheet" href="invoiceassets/css/custom-5.css">
	<link rel="stylesheet" href="invoiceassets/css/media-query-5.css">
</head>
<body>
                                ...
                                if (!empty($dataInvoiceDetail)) {
                                    ...
                                    foreach ($dataInvoiceDetail as $item) {
                                        ...
                                        <tr class="invo-tb-row">
                                            ...
                                            <td class="invo-tb-data rate-data font-sm"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($item['price'], 2); ?></td>
                                            <td class="invo-tb-data rate-data font-sm text-right pr-10"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($total, 2); ?></td>
                                        </tr>
                                        <?php
                                        $sl+=1;
                                    }
								...
								<table class="invo-total-table ">
                                    ...
                                    ?>
										...
										<tr class="invo-grand-total">
											...
											<td class="font-18-500 color-light-black text-right pr-10 pt-20"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($grandTotal, 2); ?></td>
										</tr>
									</tbody>
								</table>
							</div>
...
?>
	...
	<script src="invoiceassets/js/jquery.min-5.js"></script>
	<script src="invoiceassets/js/jspdf.min-5.js"></script>
	<script src="invoiceassets/js/html2canvas.min-5.js"></script>
	<script src="invoiceassets/js/custom-5.js"></script>
</body>
</html>
<?php
    }else{
