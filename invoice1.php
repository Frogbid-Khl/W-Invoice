                            ...
                            <div class="table-wrapper agency-service-table pt-32">
                                <table class="invoice-table agency-table">
                                    ...
                                    <tr class="invo-tb-header bg-black">
                                        <th class="serv-wid pl-10 font-md">Product</th>
                                        ...
                                        foreach ($dataInvoiceDetail as $item) {
                                            ...
                                            <tr class="invo-tb-row">
                                                ...
                                                <td class="font-sm text-right pr-10">
                                                    <?= $dataInvoice[0]['icurrency']; ?> <?= number_format($total, 2); ?></td>
                                            </tr>
                                            <?php
                                        }
                                    }
                                    ...
                                    <table class="invo-total-table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-md-grey color-grey text-right pr-10">
                                                <?= $dataInvoice[0]['icurrency']; ?> <?= number_format($subTotal, 2); ?></td>
                                        </tr>
                                        <tr class="tax-row">
                                            <td class="font-md color-light-black">Tax <span
                                                        class="color-grey">(<?= number_format(($tax / $subTotal) * 100, 2); ?>%)</span>
                                            </td>
                                            <td class="font-md-grey color-grey text-right pr-10">
                                                <?= $dataInvoice[0]['icurrency']; ?> <?= number_format($tax, 2); ?></td>
                                        </tr>
                                        <tr class="invo-grand-total bg-blue">
                                            <td class="font-18-700 padding">Grand Total:</td>
                                            <td class="font-18-500 text-right pr-10">
                                                <?= $dataInvoice[0]['icurrency']; ?> <?= number_format($grandTotal, 2); ?></td>
                                        </tr>
