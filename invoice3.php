                                ...
                                if (!empty($dataInvoiceDetail)) {
                                    ...
                                    foreach ($dataInvoiceDetail as $item) {
                                        ...
                                        <tr class="invo-tb-row">
                                            ...
                                            <td class="font-sm color-grey text-center">Tk <?= number_format($total, 2); ?></td>
                                        </tr>
                                        <?php
                                        $i+=1;
                                    }
								...
								<table class="invo-total-table">
									...
									<tbody>
										<tr>
											...
											<td class="font-md-grey color-grey text-center">Tk <?= number_format($subTotal, 2); ?></td>
										</tr>
										<tr class="tax-row">
											<td class="font-md color-light-black">Tax <span class="font-md color-grey">(<?= number_format(($tax/$subTotal)*100, 2); ?>%)</span></td>
											<td class="font-md-grey color-grey text-center">Tk <?= number_format($tax, 2); ?></td>
										</tr>
										<tr class="invo-grand-total">
											<td class="color-yellow font-18-700 pt-20">Grand Total:</td>
											<td class="font-18-500 color-light-black pt-20 text-center">Tk <?= number_format($grandTotal, 2); ?></td>
										</tr>
									</tbody>
								</table>
							</div>
