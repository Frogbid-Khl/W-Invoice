				...
				<header class="bg-yellow restaurant-header" id="invo_header">
					<div class="invoice-logo-content">
						<div class="invoice-logo-details wid-50">
							<a href="#" class="restaurant-logo"><?php
					...
					<div class="container">
						<div class="bus-invo-no-date-wrap">
							<div class="bus-invo-num">
								...
								<span class="font-md-grey color-light-black">#<?= $dataInvoice[0]['iinv_no']; ?></span>
							</div>
						...
						<div class="invoice-owner-conte-wrap pt-20">
							<div class="invo-to-wrap">
								<div class="invoice-to-content">
                                    ...
                                    $lines = explode("\n", $dataInvoice[0]['ifrom']);
                                    ?>
									<h1 class="font-lg color-yellow pt-10"><?= htmlspecialchars($lines[0]); ?></h1>
                                ...
                                if (!empty($dataInvoiceDetail)) {
                                    ...
                                    foreach ($dataInvoiceDetail as $item) {
                                        ...
                                        <tr class="invo-tb-row">
                                            <td class="font-sm color-grey"><?= $i; ?></td>
                                            <td class="font-sm color-grey"><?= htmlspecialchars($item['pname']); ?></td>
                                            <td class="font-sm color-grey text-center"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($item['price'], 2); ?></td>
                                            <td class="font-sm color-grey text-center"><?= htmlspecialchars($item['qty']); ?></td>
                                            <td class="font-sm color-grey text-center"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($total, 2); ?></td>
                                        </tr>
                                        <?php
                                        $i+=1;
                                    }
								...
								<table class="invo-total-table">
									...
									<tbody>
										<tr>
											...
											<td class="font-md-grey color-grey text-center"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($subTotal, 2); ?></td>
										</tr>
										<tr class="tax-row">
											<td class="font-md color-light-black">Tax <span class="font-md color-grey">(<?= number_format(($tax/$subTotal)*100, 2); ?>%)</span></td>
											<td class="font-md-grey color-grey text-center"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($tax, 2); ?></td>
										</tr>
										<tr class="invo-grand-total">
											<td class="color-yellow font-18-700 pt-20">Grand Total:</td>
											<td class="font-18-500 color-light-black pt-20 text-center"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($grandTotal, 2); ?></td>
										</tr>
									</tbody>
								</table>
							</div>
