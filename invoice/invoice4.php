...
<head>
	...
	<link href="assets/images/favicon/icon-3.png" rel="icon">
	...
	<link rel="stylesheet" href="assets/css/media-query-3.css">
</head>
<body>
	...
	<script src="assets/js/jquery.min-3.js"></script>
	<script src="assets/js/jspdf.min-3.js"></script>
	<script src="assets/js/html2canvas.min-3.js"></script>
	<script src="assets/js/custom-3.js"></script>
</body>
</html>
    <?php
}else{
