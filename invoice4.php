                                ...
                                if (!empty($dataInvoiceDetail)) {
                                    foreach ($dataInvoiceDetail as $item) {
                                        ...
                                        <tr class="invo-tb-row">
                                            ...
                                            <td class="font-sm color-grey text-right"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($total, 2); ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
								...
								<table class="invo-total-table">
                                    ...
                                    ?>
										...
										<tr class="invo-grand-total">
											...
											<td class="font-18-500 pt-20 color-light-black text-right"><?= $dataInvoice[0]['icurrency']; ?> <?= number_format($grandTotal, 2); ?></td>
										</tr>
									</tbody>
								</table>
							</div>
